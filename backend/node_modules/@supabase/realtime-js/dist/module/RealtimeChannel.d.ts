import type { ChannelState } from '@supabase/realtime-js/dist/module/lib/constants';
...
import { ChannelBindingCallback } from '@supabase/realtime-js/dist/module/phoenix/types';
import type { Timer } from '@supabase/realtime-js/dist/module/phoenix/types';
import { RealtimePostgresFilterBuilder } from '@supabase/realtime-js/dist/module/RealtimePostgresFilterBuilder';
export type { RealtimePostgresChangesFilterOperator } from '@supabase/realtime-js/dist/module/RealtimePostgresFilterBuilder';
export { RealtimePostgresFilterBuilder, postgresChangesFilter, } from '@supabase/realtime-js/dist/module/RealtimePostgresFilterBuilder';
type ReplayOption = {
    since: number;
    limit?: number;
};
...
export default class RealtimeChannel {
    ...
    get timeout(): number;
    get joinPush(): import("../../../phoenix/priv/static/types").Push;
