...
import { EIP1193Provider, EthereumSignInInput, Hex } from '@supabase/auth-js/dist/module/lib/web3/ethereum';
import type { SolanaSignInInput, SolanaSignInOutput } from '@supabase/auth-js/dist/module/lib/web3/solana';
import { ServerCredentialCreationOptions, ServerCredentialRequestOptions, WebAuthnApi, WebAuthnError } from '@supabase/auth-js/dist/module/lib/webauthn';
import type { RegistrationResponseJSON, AuthenticationResponseJSON, ServerCredentialResponse } from '@supabase/auth-js/dist/module/lib/webauthn';
import { AuthenticationCredential, PublicKeyCredentialCreationOptionsFuture, PublicKeyCredentialRequestOptionsFuture, RegistrationCredential } from '@supabase/auth-js/dist/module/lib/webauthn.dom';
