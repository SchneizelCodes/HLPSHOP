import { StrictOmit } from '@supabase/auth-js/dist/module/lib/types';
import { PublicKeyCredentialCreationOptionsFuture, PublicKeyCredentialRequestOptionsFuture } from '@supabase/auth-js/dist/module/lib/webauthn.dom';
/**
